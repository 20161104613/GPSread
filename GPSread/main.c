...
int main(int argc, const char * argv[]) {
    ...
    int Gps;
    fp1=fopen("//Users//a20161104613//Desktop//GPSread//maopao.txt","w+");
    fp2=fopen("//Users//a20161104613//Desktop//GPSread//GPS170510.log","r");
    fp3=fopen("//Users//a20161104613//Desktop//GPSread//sort.csv","w+");
    if(fp2==NULL)
    {
